...
class HanzitopinyinandroidModule : public titanium::Proxy
{
public:
	explicit HanzitopinyinandroidModule(jobject javaObject);
...
private:
	// Methods -----------------------------------------------------------
	static v8::Handle<v8::Value> HanZiToPinYin(const v8::Arguments&);
